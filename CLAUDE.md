...
node scripts/fetch-blog-posts.js      # update blog section in README
node scripts/fetch-youtube-videos.js  # update YouTube section (needs YOUTUBE_API_KEY env var)
```
...
- **scripts/** — Node 20 ESM scripts that parse RSS/YouTube feeds and splice content into README via marker comments
